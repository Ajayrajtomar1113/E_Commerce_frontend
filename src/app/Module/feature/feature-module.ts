...
@NgModule({
  declarations: [Feature, Home, MainCarousel, ProductSlider, HomeProductCart, Products],
  imports: [CommonModule,MatCheckboxModule,MatMenuModule,MatIconModule,MatButtonModule,MatDividerModule,MatRadioModule,SharedModule],
